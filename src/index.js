...
function getLandingPage() {
  return '<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Ultra VPN — Надёжный VPN сервис</title><style>*{margin:0;padding:0;box-sizing:border-box}body{font-family:"Segoe UI",system-ui,sans-serif;background:#0b0e14;color:#e4e9f0;min-height:100vh;display:flex;flex-direction:column}.container{max-width:1100px;margin:0 auto;padding:0 20px;width:100%}/* HEADER */header{padding:24px 0;border-bottom:1px solid #1e293b;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:16px}.logo{font-size:24px;font-weight:700;background:linear-gradient(135deg,#58a6ff,#a78bfa);-webkit-background-clip:text;-webkit-text-fill-color:transparent}.logo span{color:#e4e9f0;-webkit-text-fill-color:#e4e9f0}.nav{display:flex;gap:24px;align-items:center;flex-wrap:wrap}.nav a{color:#8b95a9;text-decoration:none;font-size:14px;transition:0.2s}.nav a:hover{color:#e4e9f0}.nav .btn{background:linear-gradient(135deg,#3b82f6,#8b5cf6);color:#fff;padding:8px 24px;border-radius:99px;font-weight:600;font-size:14px;border:none;cursor:pointer;transition:0.3s}.nav .btn:hover{opacity:0.8;transform:translateY(-2px)}/* HERO */section{padding:60px 0}.hero{text-align:center}.hero h1{font-size:48px;font-weight:700;margin-bottom:16px;background:linear-gradient(135deg,#fff,#8b95a9);-webkit-background-clip:text;-webkit-text-fill-color:transparent}.hero p{font-size:18px;color:#8b95a9;max-width:600px;margin:0 auto 32px;line-height:1.6}.hero .btn{background:linear-gradient(135deg,#3b82f6,#8b5cf6);color:#fff;padding:14px 48px;border-radius:99px;font-weight:600;font-size:16px;border:none;cursor:pointer;transition:0.3s;display:inline-block;text-decoration:none}.hero .btn:hover{opacity:0.8;transform:translateY(-2px);box-shadow:0 8px 30px rgba(59,130,246,0.3)}/* FEATURES */.features{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:24px;margin-top:40px}.feature{background:#141a24;padding:32px 24px;border-radius:16px;border:1px solid #1e293b;text-align:center;transition:0.3s}.feature:hover{border-color:#3f3f46;transform:translateY(-4px)}.feature .icon{font-size:40px;margin-bottom:12px}.feature h3{font-size:18px;margin-bottom:8px}.feature p{color:#8b95a9;font-size:14px;line-height:1.6}/* SERVERS */.servers-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;margin-top:24px}.server-card{background:#111113;padding:16px;border-radius:12px;border:1px solid #1e1e21;text-align:center}.server-card .flag{font-size:28px}.server-card .name{font-weight:500;margin-top:4px}.server-card .ping{color:#58a6ff;font-size:13px;margin-top:2px}.server-card .speed{color:#22c55e;font-size:13px}/* CTA */.cta{text-align:center;background:linear-gradient(145deg,#18181b,#0d0d10);padding:48px;border-radius:28px;border:1px solid #27272a}.cta h2{font-size:28px;margin-bottom:12px}.cta p{color:#8b95a9;font-size:16px;margin-bottom:24px}.cta .btn{background:linear-gradient(135deg,#3b82f6,#8b5cf6);color:#fff;padding:14px 48px;border-radius:99px;font-weight:600;font-size:16px;border:none;cursor:pointer;transition:0.3s;display:inline-block;text-decoration:none}.cta .btn:hover{opacity:0.8;transform:translateY(-2px)}/* FOOTER */footer{padding:24px 0;border-top:1px solid #1e293b;text-align:center;color:#4b5563;font-size:14px;margin-top:auto}footer a{color:#58a6ff;text-decoration:none}footer a:hover{text-decoration:underline}@media(max-width:600px){.hero h1{font-size:32px}.features{grid-template-columns:1fr}.servers-grid{grid-template-columns:1fr 1fr}.cta{padding:32px 20px}}</style></head><body><header><div class="container"><div class="logo">Ultra <span>VPN</span></div><div class="nav"><a href="#features">Возможности</a><a href="#servers">Серверы</a><a href="#contact">Контакты</a><a href="/admin?pass=18032014" class="btn">Админ-панель</a></div></div></header><main><section class="hero"><div class="container"><h1>Безлимитный VPN <br>для свободного интернета</h1><p>Надёжные серверы в Европе и России. Безлимитный трафик, высокая скорость и полная анонимность.</p><a href="#contact" class="btn">Начать использовать</a></div></section><section id="features"><div class="container"><h2 style="font-size:28px;text-align:center;margin-bottom:8px">🔥 Почему мы?</h2><p style="color:#8b95a9;text-align:center;font-size:16px;margin-bottom:8px">Всё, что нужно для комфортного серфинга</p><div class="features"><div class="feature"><div class="icon">🌍</div><h3>5 серверов</h3><p>Германия, Швеция, Польша, Россия, LTE — выбирай любой</p></div><div class="feature"><div class="icon">📦</div><h3>Безлимитный трафик</h3><p>Никаких ограничений по объёму — качай и смотри сколько хочешь</p></div><div class="feature"><div class="icon">⚡</div><h3>Высокая скорость</h3><p>Скорость от 70 до 500 Мбит/с — идеально для стримов и игр</p></div><div class="feature"><div class="icon">🔒</div><h3>Reality протокол</h3><p>Современная защита, которая не оставляет следов</p></div><div class="feature"><div class="icon">📱</div><h3>Все устройства</h3><p>Windows, macOS, Android, iOS — подключай что угодно</p></div><div class="feature"><div class="icon">💬</div><h3>Поддержка 24/7</h3><p>Всегда на связи в Telegram — поможем с настройкой</p></div></div></div></section><section id="servers"><div class="container"><h2 style="font-size:28px;text-align:center;margin-bottom:8px">🖥️ Наши серверы</h2><p style="color:#8b95a9;text-align:center;font-size:16px;margin-bottom:8px">Реальные пинг и скорость (обновляются автоматически)</p><div class="servers-grid"><div class="server-card"><div class="flag">🇩🇪</div><div class="name">Германия</div><div class="ping">📶 80 мс</div><div class="speed">⚡ 210 Мбит/с</div></div><div class="server-card"><div class="flag">🇸🇪</div><div class="name">Швеция</div><div class="ping">📶 94 мс</div><div class="speed">⚡ 158 Мбит/с</div></div><div class="server-card"><div class="flag">🇵🇱</div><div class="name">Польша</div><div class="ping">📶 87 мс</div><div class="speed">⚡ 122 Мбит/с</div></div><div class="server-card"><div class="flag">🇷🇺</div><div class="name">Россия</div><div class="ping">📶 14 мс</div><div class="speed">⚡ 98 Мбит/с</div></div><div class="server-card"><div class="flag">🇩🇪</div><div class="name">LTE #1</div><div class="ping">📶 24 мс</div><div class="speed">⚡ 154 Мбит/с</div></div></div></div></section><section id="contact"><div class="container"><div class="cta"><h2>🚀 Готов начать?</h2><p>Получи доступ к Ultra VPN прямо сейчас. Безлимитный трафик, высокая скорость и полная анонимность.</p><a href="https://t.me/fhcsupport" class="btn" target="_blank">💬 Связаться с нами</a><p style="margin-top:16px;font-size:14px;color:#4b5563">Вопросы? Пиши в Telegram — <a href="https://t.me/fhcsupport" style="color:#58a6ff;">@fhcsupport</a></p></div></div></section></main><footer><div class="container"><p>© 2026 Ultra VPN. Все права защищены. Работает на <a href="https://cloudflare.com" target="_blank">Cloudflare Workers</a></p></div></footer></body></html>';
}
