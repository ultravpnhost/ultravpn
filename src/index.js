export default {
  async fetch(request, env, ctx) {
    ...
    // Если параметры есть - отдаём JSON
    if (id && sign) {
      const jsonData = [
        {
          "dns": {
          ...
          "routing": {
            ...
            "balancers": [{
              ...
              "strategy": {
                ...
                "settings": {
                  "baselines": ["4s"],
                  "costs": [{ "match": "de-1", "regexp": false, "value": 1 }],
                  "expected": 1,
                  "maxRTT": "6s"
                }
              }
          ...
          "routing": {
            ...
            "balancers": [{
              ...
              "strategy": {
                ...
                "settings": {
                  "baselines": ["4s"],
                  "costs": [{ "match": "se-1", "regexp": false, "value": 1 }],
                  "expected": 1,
                  "maxRTT": "6s"
                }
              }
          ...
          "routing": {
            ...
            "balancers": [{
              ...
              "strategy": {
                ...
                "settings": {
                  "baselines": ["4s"],
                  "costs": [{ "match": "pl-1", "regexp": false, "value": 1 }],
                  "expected": 1,
                  "maxRTT": "6s"
                }
              }
          ...
          "routing": {
            ...
            "balancers": [{
              ...
              "strategy": {
                ...
                "settings": {
                  "baselines": ["4s"],
                  "costs": [{ "match": "fi-1", "regexp": false, "value": 1 }],
                  "expected": 1,
                  "maxRTT": "6s"
                }
              }
          ...
          "routing": {
            ...
            "balancers": [{
              ...
              "strategy": {
                ...
                "settings": {
                  "baselines": ["4s"],
                  "costs": [{ "match": "ru-1", "regexp": false, "value": 1 }],
                  "expected": 1,
                  "maxRTT": "6s"
                }
              }
          ...
          "routing": {
            ...
            "balancers": [{
              ...
              "strategy": {
                ...
                "settings": {
                  "baselines": ["4s"],
                  "costs": [{ "match": "tr-1", "regexp": false, "value": 1 }],
                  "expected": 1,
                  "maxRTT": "6s"
                }
              }
          ...
          "routing": {
            ...
            "balancers": [{
              ...
              "strategy": {
                ...
                "settings": {
                  "baselines": ["4s"],
                  "costs": [{ "match": "mobile-1", "regexp": false, "value": 1 }],
                  "expected": 1,
                  "maxRTT": "6s"
                }
              }
    ...
    // Если параметров нет - маскируемся под обычный сайт
    return new Response(`
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="container">
            <h1>🛡️ Secure VPN Service</h1>
            <p>Защищённое подключение к сети<br>Работает только с валидными параметрами</p>
          </div>
        </body>
      </html>
    `, {
