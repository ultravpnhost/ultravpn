export default {
  async fetch(request, env, ctx) {
    ...
    const realNodes = [
      ...
      { tag: "nl-1", address: "city-most-5.harknmav.fun", port: 443, id: "a6c595e7-34e2-4762-8947-1ffd25bf99de", serverName: "max.ru", publicKey: "BGW71GlS7ucRWEx-tYF0n2JKvo8uBSLnKdtMMdwBNDY", shortId: "88ec10761480dce4", fingerprint: "qq", remarks: "🇳🇱 Нидерланды", network: "tcp", flow: "xtls-rprx-vision" },
      { tag: "tr-1", address: "tr.datanode-internal.net", port: 443, id: "9d5e7e04-53e4-4d98-bb26-236c907078a5", serverName: "sun9-38.userapi.com", publicKey: "r6lN34m1nN-xQZ458j5NPD5xJ3_QBF2bGzY4KJEo4ic", shortId: "abbcd128", fingerprint: "firefox", remarks: "🇹🇷 Турция", network: "tcp", flow: "xtls-rprx-vision" },
