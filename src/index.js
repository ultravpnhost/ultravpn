export default {
  async fetch(request, env, ctx) {
    ...
    // --- ПРОВЕРКА: ХОТИМ ЛИ ПОСМОТРЕТЬ ВЕБ-СТРАНИЦУ ---
    ...
    // --- ГЕНЕРАЦИЯ СТАНДАРТНЫХ ССЫЛОК ДЛЯ КЛИЕНТОВ (VLESS://) ---
    ...
    // Отдаем как text/plain, чтобы регулярки клиентов гарантированно читали тело ответа
