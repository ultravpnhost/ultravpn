export default {
  async fetch(request, env, ctx) {
    ...
    const realNodes = [
      ...
      { tag: "lte-2", address: "84.201.178.0", port: 443, id: "694eadbe-d61f-4f80-957b-d55d990e8ffa", serverName: "yandex.ru", publicKey: "ONSC3Bp5U0cjkMca7bXlUI16izIeN0fJKoCjEdn64RQ", shortId: "2bb326a463fd1937", fingerprint: "firefox", remarks: "🇷🇺 LTE #2", network: "tcp", flow: "xtls-rprx-vision" },
      { tag: "lte-3", address: "city-most-5.harknmav.fun", port: 443, id: "a6c595e7-34e2-4762-8947-1ffd25bf99de", serverName: "max.ru", publicKey: "BGW71GlS7ucRWEx-tYF0n2JKvo8uBSLnKdtMMdwBNDY", shortId: "88ec10761480dce4", fingerprint: "qq", remarks: "🇳🇱 LTE #3", network: "tcp", flow: "xtls-rprx-vision" }
    ];
