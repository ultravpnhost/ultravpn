export default {
  async fetch(request, env, ctx) {
    ...
    if (path.startsWith('/sub/')) {
      ...
      const isClientSub = accept.includes('application/json') || 
                           userAgent.includes('V2Ray') || 
                           userAgent.includes('Happ') || 
                           userAgent.includes('sing-box') || 
                           userAgent.includes('INCY');
